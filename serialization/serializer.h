...
struct INodeSerializer
{
    ...
    virtual void WriteCollectionStart(const std::wstring& name, const size_t& collectionLevel) = 0;
    /// <summary>
    ...
    virtual void WriteCollectionEnd(const std::wstring& name, const size_t& collectionLevel, bool nextFieldExist) = 0;
    /// <summary>
    /// Write field
    /// </summary>
    ...
    /// <param name="nextFieldExist">Flag signifying that on current collection level will be another objects</param>
    virtual void WriteField(const std::wstring& name, const SerializableValue& value, const size_t& fieldLevel, bool nextFieldExist) = 0;
};
